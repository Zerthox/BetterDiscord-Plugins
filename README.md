...
### [BetterFolders](/v1/BetterFolders.plugin.js) <sub><sup>`v2.3.0` *(Updated: 18/11/20)*</sup></sub>
Add new functionality to server folders.
Current Features:
- Custom Folder Icons
- Close other folders on open

### [OnlineFriendCount](/v1/OnlineFriendCount.plugin.js) <sub><sup>`v1.4.0` *(Updated: 18/11/20)*</sup></sub>
Add the old online friend count back to guild list. Because nostalgia.

### [VoiceEvents](/v1/VoiceEvents.plugin.js) <sub><sup>`v1.3.4` *(Updated: 23/02/21)*</sup></sub>
