import {createPlugin, Finder, PatchDataWithResult, Patcher, React, Utils} from "dium";
...
const embedStyles = Finder.byProps(["embedWrapper"]);
...
export default createPlugin({
    ...
    styles: styles + `
        .${embedStyles.container.replaceAll(" ", ".")} {
