...
export const SimpleMarkdown: typeof import("simple-markdown") = /* @__PURE__ */ Finder.byKeys(["parseBlock", "parseInline"]);

export const hljs: typeof import("highlight.js").default = /* @__PURE__ */ Finder.byKeys(["highlight", "highlightBlock"]);
